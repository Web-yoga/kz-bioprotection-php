...
$biologicalPlantProtectionTopPictureUrls = [
...
$diagramGrowthStepCount = count($biologicalPlantProtectionTopPictureUrls);
...
<div class="plant-protection-growth-diagram">
	<div class="diagram-growth" style="--diagram-n: <?= $diagramNAttr; ?>">
		<?php foreach ($biologicalPlantProtectionTopPictureUrls as $stepIndex => $imageUrl): ?>
